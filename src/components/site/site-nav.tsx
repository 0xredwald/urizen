...
const LINKS: NavItem[] = [
  ...
  { label: "Developers", children: [{ label: "Docs", href: "/docs" }, { label: "Skill", href: "/skill" }, { label: "x402 API", href: "/x402" }] },
];
        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          <div className="hidden items-center sm:flex">
            <Link
              ...
              className="grid size-9 shrink-0 place-items-center border border-white/15 text-muted-foreground transition-colors hover:border-signal hover:text-signal"
            >
            ...
            <Link
              ...
              className="-ml-px grid size-9 shrink-0 place-items-center border border-white/15 text-muted-foreground transition-colors hover:border-signal hover:text-signal"
            >
